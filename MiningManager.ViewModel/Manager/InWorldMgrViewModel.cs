...
namespace MiningManager.ViewModel
{
    ...
    public class InWorldMgrViewModel<S, T, U, V, W> : BaseViewModel
    ...
    {
        public IInWorldManagerController<S, T, U, V> _itemManagerController
            => (IInWorldManagerController < S, T, U, V>)Controller;

        #region Constructeurs

        public InWorldMgrViewModel(IController controller) : base(controller)
        {
